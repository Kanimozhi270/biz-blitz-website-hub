    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
        ...
        <div className="container mx-auto text-center">
          <div className="mb-8">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
              <span className="inline-block animate-fade-in-up">Nithra Digital Card</span>
              <br />
              <span className="text-purple-600 inline-block animate-fade-in-up" style={{ animationDelay: '0.4s' }}>Create your online business</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto animate-fade-in-up" style={{ animationDelay: '0.7s' }}>
              Digital Business card platform makes designing a card or Mini ecommerce store simple, convenient, and reliable.
            </p>
            <p className="text-lg text-gray-700 mb-8 font-semibold animate-fade-in-up" style={{ animationDelay: '0.9s' }}>
              Create what you need in Just 5 minutes !!
            </p>
            <Button 
              size="lg" 
              className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 text-lg rounded-lg animate-fade-in-up"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-12 max-w-4xl mx-auto">
            {/* Left: Vertical Cards */}
            <div className="flex flex-col space-y-8 w-full md:w-1/2">
              ...
              <Card className="p-6 animate-fade-in-left" style={{ animationDelay: '0.2s' }}>
                <div className="flex items-start space-x-4">
              ...
              <Card className="p-6 animate-fade-in-left" style={{ animationDelay: '0.4s' }}>
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Share2 className="text-green-600" size={24} />
                  </div>
                  <div>
                    <h3 className="text-xl font-bold text-gray-900 mb-2">Share with friends and colleagues</h3>
            ...
            {/* Right: Mobile Image */}
            <div className="w-full md:w-1/2 flex justify-center animate-fade-in-right" style={{ animationDelay: '0.4s' }}>
              <img 
                src="/mobile.png" 
                alt="Mobile Mockup" 
                className="max-w-[220px] w-full h-auto drop-shadow-2xl rounded-2xl border border-gray-200 bg-white"
              />
            </div>
          </div>
        </div>
